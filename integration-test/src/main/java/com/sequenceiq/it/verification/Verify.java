...
public class Verify {
    ...
    public Verify(String path, String httpMethod, Map<Call, Response> requestResponseMap, boolean regex) {
        this.path = path;
        this.regex = regex;
    ...
    public Verify bodyContains(String text) {
        bodyContainsList.add(text);
        return this;
    }

    public Verify bodyRegexp(String regexp) {
